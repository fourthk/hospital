...
@section('container')
    <form class="max-w-sm" action="/admin/news/{{ $news->id }}" method="post">
        @method('PUT')
        @csrf
        <div class="mb-5">
        ...
        <div class="mb-5">
            <label for="img_url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Image Url</label>
            <input type="text" id="img_url" name="img_url" value="{{ $news->img_url }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>

        <div class="mb-5">
            <label for="news_url" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">News Url</label>
            <input type="text" id="news_url" name="news_url" value="{{ $news->news_url }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        </div>
