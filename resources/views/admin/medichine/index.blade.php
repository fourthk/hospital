    ...
    <div class="p-4 relative overflow-x-auto shadow-md sm:rounded-lg">
        <form action="">
            <div class="pb-4 flex justify-between bg-white dark:bg-gray-900">
                ...
                <a href="/admin/create/medichine"><button type="button"
            ...
            <tbody>
                @foreach ($medichines as $medichine)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            {{ $medichine->medichineCategory->name }}
                        </td>
                        <td class="px-6 py-4">
                            Rp{{ $medichine->price }}
                        </td>
                        ...
                        <td class="px-6 py-4 flex gap-4">
                            <a href="/admin/medichine/{{ $medichine->id }}"
                                class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            <button id="trigger-modal" onclick="urlModalHandler(this)"
                                data-id-target="{{ route('admin.medichine.destroy', $medichine->id) }}"
